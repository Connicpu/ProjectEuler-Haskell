module Main (spiralGrid, printGrid, lDiag, rDiag, main) where
      ...
      where
        ...
        numAt n'' x' y' =
          ...
          where
            ...
            start = innerDiameter^(2::Integer) + 1
...
main = do
  args <- getArgs
  let radius = read $ args !! 0
  putStrLn.printGrid $ spiralGrid radius
